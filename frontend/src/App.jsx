        ...
        <header className="pt-[env(safe-area-inset-top)]">
          <div className="flex items-center justify-between pt-5 pb-4">
            ...
            <div className="flex items-center gap-4">
              <Link to="/events" className="text-primary text-sm font-medium hover:text-interactive transition">Sessions</Link>
              <Link to="/shop" className="text-primary text-sm font-medium hover:text-interactive transition">Shop</Link>
              <ThemeToggle />
            </div>
          </div>
        </header>
