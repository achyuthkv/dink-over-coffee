...
export const api = {
  ...
  membershipAvailability: () => call('membership', { action: 'availability' }),
  membershipWhoami: (token) => call('membership', { action: 'whoami' }, token),
  membershipWaitlistInterest: (details) => call('membership', { action: 'waitlist-interest', ...details }),
