        ...
        <form onSubmit={handleSubmit} className="card space-y-3 overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="overflow-hidden">
              ...
              <input type="time" className="block w-full max-w-full mt-1 rounded-xl border border-coffee-200 bg-white px-3 py-2 text-sm focus:border-coffee-600 focus:outline-none [&::-webkit-date-and-time-value]:text-left" value={startTime} onChange={e => { setStartTime(e.target.value); update('time', formatTime(e.target.value, endTime)) }} required />
            </div>
            <div className="overflow-hidden">
              <label className="text-[11px] font-semibold text-coffee-600 uppercase tracking-wide">To</label>
              <input type="time" className="block w-full max-w-full mt-1 rounded-xl border border-coffee-200 bg-white px-3 py-2 text-sm focus:border-coffee-600 focus:outline-none [&::-webkit-date-and-time-value]:text-left" value={endTime} onChange={e => { setEndTime(e.target.value); update('time', formatTime(startTime, e.target.value)) }} required />
            </div>
          </div>
