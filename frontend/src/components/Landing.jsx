    ...
    <div className="min-h-screen bg-bg-alt flex flex-col">
      ...
      <nav className="px-6 md:px-12 lg:px-20 max-w-7xl mx-auto w-full pt-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="https://www.instagram.com/dinkovercoffee" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full border border-border text-muted hover:text-primary active:bg-surface transition" title="Instagram">
      ...
      <section className="px-6 md:px-12 lg:px-20 max-w-7xl mx-auto w-full pt-12 pb-10 md:pt-20 md:pb-16 lg:pt-24 lg:pb-20 flex flex-col lg:flex-row lg:items-center lg:gap-16">
        ...
        <div className="mt-10 lg:mt-0 lg:w-[380px] shrink-0 space-y-5">
          {sessions.length > 0 && (
            <div>
              <p className="text-muted text-[10px] uppercase tracking-[0.3em] mb-2">Upcoming sessions</p>
      ...
      <footer className="px-6 md:px-12 lg:px-20 max-w-7xl mx-auto w-full py-6 mt-auto border-t border-border">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href="https://www.instagram.com/dinkovercoffee" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full border border-border text-muted hover:text-primary transition" title="Instagram">
            ...
            <a href="https://chat.whatsapp.com/CxCddkzBtqc2uARp4tcPDy?s=cl&p=i&mlu=3" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full border border-border text-muted hover:text-primary transition" title="WhatsApp Community">
