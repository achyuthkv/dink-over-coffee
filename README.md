...
6. **Go live**: once fixtures are ready, flip the always-visible status control from `Setup` to `Active` so the tournament appears on the public `/tournament` (Live) tab.
