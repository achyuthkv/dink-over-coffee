...
**Guided flow, top to bottom on the `/admin` tournament screen:**
...
10. Once the final is scored, its winner is shown as tournament champion, both in `/admin` and on the public page.
11. Flip status to `completed` once it's over — see "Public visibility" below for what that does.
